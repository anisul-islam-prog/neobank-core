...
/**
 * Minimal test configuration for Cards module slice tests.
 * Provides a modular test root that avoids scanning the main application class.
 */
@SpringBootConfiguration
@EnableAutoConfiguration
@EntityScan("com.neobank.cards")
@EnableJpaRepositories("com.neobank.cards")
public class CardsTestConfig {
