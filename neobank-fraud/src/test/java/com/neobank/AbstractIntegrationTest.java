 ...
 *
 * Uses @SpringBootTest with WebEnvironment.NONE to prevent web server startup
 * while maintaining @ServiceConnection for automatic DataSource configuration.
 */
...
public abstract class AbstractIntegrationTest {
     ...
     * Testcontainers 2.0+ with Spring Boot 4 @ServiceConnection for auto-configuration.
     */
    @Container
    @ServiceConnection
