...
@ActiveProfiles("test")
@Transactional
@Import(FraudIntegrationTestConfig.class)
...
class FraudRepositoryIntegrationTest {
    ...
    class SaveAndRetrieveTests {
        ...
        void shouldSaveAndRetrieveFraudAlertById() {
            ...
            // When
            FraudEntity saved = repository.save(fraudEntity);
            FraudEntity retrieved = repository.findById(saved.getId()).orElse(null);
    ...
    class FindByTransferIdTests {
        ...
        void shouldFindFraudAlertByTransferId() {
            ...
            repository.save(fraudEntity);

            // When
            Optional<FraudEntity> result = repository.findByTransferId(transferId);
        ...
        void shouldReturnEmptyWhenFraudAlertNotFoundByTransferId() {
            ...
            // When
            Optional<FraudEntity> result = repository.findByTransferId(nonExistentTransferId);
    ...
    class FindByAccountIdTests {
        ...
        void shouldReturnEmptyListWhenNoFraudAlertsForAccount() {
            ...
            // When
            List<FraudEntity> results = repository.findByFromAccountIdOrderByCreatedAtDesc(nonExistentAccountId);
    ...
    class FindByStatusTests {
        ...
        void shouldFindAllPendingFraudAlerts() {
            ...
            // When
            List<FraudEntity> results = repository.findByStatusOrderByCreatedAtDesc(FraudEntity.FraudStatus.PENDING);
        ...
        void shouldFindAllConfirmedFraudAlerts() {
            ...
            repository.save(confirmed1);

            FraudEntity confirmed2 = createTestFraudEntity(UUID.randomUUID());
            confirmed2.setStatus(FraudEntity.FraudStatus.CONFIRMED_FRAUD);
            repository.save(confirmed2);

            // When
            List<FraudEntity> results = repository.findByStatusOrderByCreatedAtDesc(FraudEntity.FraudStatus.CONFIRMED_FRAUD);
    ...
    class CountByStatusTests {
        ...
        void shouldCountFraudAlertsByStatus() {
            ...
            // When
            long pendingCount = repository.countByStatus(FraudEntity.FraudStatus.PENDING);
            long confirmedCount = repository.countByStatus(FraudEntity.FraudStatus.CONFIRMED_FRAUD);
        ...
        void shouldReturn0WhenNoFraudAlertsForStatus() {
            // When
            long count = repository.countByStatus(FraudEntity.FraudStatus.PENDING);
    ...
    class UpdateStatusTests {
        ...
        void shouldUpdateFraudAlertStatus() {
            ...
            Optional<FraudEntity> updatedEntity = repository.findById(alertId);
        ...
        void shouldConfirmFraudAlert() {
            ...
            // When
            int confirmed = repository.confirmFraud(alertId, reviewerId);

            // Then
            assertThat(confirmed).isEqualTo(1);
            Optional<FraudEntity> confirmedEntity = repository.findById(alertId);
        ...
        void shouldMarkFraudAlertAsFalsePositive() {
            ...
            // When
            int marked = repository.markAsFalsePositive(alertId, reviewerId);

            // Then
            assertThat(marked).isEqualTo(1);
            Optional<FraudEntity> markedEntity = repository.findById(alertId);
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleDeletingFraudAlerts() {
            ...
            UUID id = UUID.randomUUID();
            FraudEntity fraudEntity = createTestFraudEntity(id);
            fraudEntity = repository.save(fraudEntity);

            // When
            repository.delete(fraudEntity);
        ...
        void shouldHandleDeletingAllFraudAlerts() {
            ...
            repository.saveAll(fraudEntities);
