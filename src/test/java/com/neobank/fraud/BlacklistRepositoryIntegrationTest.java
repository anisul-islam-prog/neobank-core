...
class BlacklistRepositoryIntegrationTest {
    ...
    class SaveAndRetrieveTests {
        ...
        void shouldSaveAndRetrieveBlacklistEntryById() {
            ...
            BlacklistEntity retrieved = blacklistRepository.findById(saved.getId()).orElse(null);
    ...
    class IsBlacklistedChecksTests {
        ...
        void shouldReturnTrueWhenUserIdIsBlacklisted() {
            ...
            // When
            boolean isBlacklisted = blacklistRepository.isUserIdBlacklisted(userId);
    ...
    class FindByEntityTypeTests {
        ...
        void shouldFindAllActiveIpAddressBlacklistEntries() {
            ...
            // When
            List<BlacklistEntity> results = blacklistRepository.findByEntityTypeAndActiveTrue(
                    BlacklistEntity.BlacklistEntityType.IP_ADDRESS
            );
        ...
        void shouldFindAllHighSeverityBlacklistEntries() {
            ...
            blacklistRepository.save(high1);
            ...
            blacklistRepository.save(high2);
            ...
            blacklistRepository.save(critical);

            // When
            List<BlacklistEntity> results = blacklistRepository.findBySeverityAndActiveTrue(
    ...
    class CountOperationsTests {
        ...
        void shouldCountActiveBlacklistEntriesByEntityType() {
            ...
            blacklistRepository.save(account);

            // When
            long ipCount = blacklistRepository.countByEntityTypeAndActiveTrue(
                    BlacklistEntity.BlacklistEntityType.IP_ADDRESS
            );
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleIpv6Address() {
            ...
            // When
            boolean isBlacklisted = blacklistRepository.isIpAddressBlacklisted(ipv6);
        ...
        void shouldHandleDeletingBlacklistEntries() {
            ...
            // Then
            assertThat(blacklistRepository.findById(id)).isEmpty();
        }
        ...
        void shouldHandleDeletingAllBlacklistEntries() {
            ...
            blacklistRepository.saveAll(blacklistEntities);

            // When
            blacklistRepository.deleteAll();

            // Then
            assertThat(blacklistRepository.findAll()).isEmpty();
        }
    }
