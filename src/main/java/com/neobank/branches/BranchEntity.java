...
/**
 * JPA entity for bank branch persistence.
 * Each branch has a unique code, name, and location details.
 */
@Entity
@Table(name = "branches", uniqueConstraints = {
        @UniqueConstraint(columnNames = "code", name = "uk_branches_code")
})
